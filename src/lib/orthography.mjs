// src/lib/orthography.mjs
//
// Lifted verbatim (functional code unchanged) from yorubadict's
// build/lib/orthography.mjs - this is the original of the three-way port
// (yorubadict -> yoruba_orthography.py -> shared/src/orthography.ts)
// mentioned throughout the wider project. Kept identical here rather than
// re-derived, so all downstream consumers agree on the same combining-mark
// codepoints.
//
